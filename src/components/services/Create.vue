      ...
      >
        ...
        <div class="col-lg-6">
          <form-group
              type="select"
              :items="[
                  { value: 30, text: $t('app.components.services.field.durations.30') },
                  { value: 60, text: $t('app.components.services.field.durations.60') },
                  { value: 90, text: $t('app.components.services.field.durations.90') },
                  { value: 120, text: $t('app.components.services.field.durations.120') },
                  { value: 150, text: $t('app.components.services.field.durations.150') },
                  { value: 180, text: $t('app.components.services.field.durations.180') },
                  { value: 210, text: $t('app.components.services.field.durations.210') },
                  { value: 240, text: $t('app.components.services.field.durations.240') },
              ]"
